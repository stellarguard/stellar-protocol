...
Name | Type | Description
-----|------|------------
`id` | any | Required. An identifier for the multisig request that is generated by the multisig service.
...
Name | Type | Description
-----|------|------------
`id` | any | Required. The id used to look up the status, which was returned in the submit transaction response.
...
`uri` | string | Required. A SEP-0007 `tx` URI that represents the current state of the transaction, including any additional signatures that have been added to the transaction since it was submitted.
